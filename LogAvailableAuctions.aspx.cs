    ...
    public partial class LogAvailableAuctions : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (auctionDDL.Items.Count == 0)
            {
                ...
                sqlCommand2.Parameters.AddWithValue("customer", custName.Text);
        ...
        protected void servCust_Click(object sender, EventArgs e)
        {
            ...
            sqlCommand20.Parameters.AddWithValue("customer", custName.Text);
            ...
            try
            {
                while (queryResults1.Read())
                {
                    ...
                    sqlCommand2.Parameters.AddWithValue("itemID", "1");
            ...
            sqlCommand9.Parameters.AddWithValue("CustomerName", HttpUtility.HtmlEncode(custName.Text));
            ...
            while (queryResults9.Read())
            {
                ...
                serviceNameHold = queryResults9["ServiceName"].ToString();
