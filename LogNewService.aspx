<%@ Page Title="" Language="C#" MasterPageFile="~/LoggedinMaster.Master" AutoEventWireup="true" CodeBehind="LogNewService.aspx.cs" Inherits="Lab2.LogNewService" %>
...
<!--Noah  George, William Kilpatrick, Henry Requeno-Villeda  2/15/2021 -->
    <div style="height: 551px">
            ...
            <br />
            <asp:ListBox ID="custRequest" runat="server" Height="96px" Width="418px"></asp:ListBox>
            ...
            <asp:Label ID="originLabel" runat="server" Text="Label"></asp:Label>
