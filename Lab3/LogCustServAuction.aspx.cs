...
namespace Lab3
{
    public partial class LogCustServAuction : System.Web.UI.Page

    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (custRequest.Items.Count == 0)
            {
                ...
                while (queryResults.Read())
                {
                    ...
                    StartDate = (queryResults["Servicedate"].ToString());
        ...
        protected void Submit_Click(object sender, EventArgs e)
        {
            ...
            if (duplicate == false)
            {
                ...
                sqlQuery1 = "Insert into Service (CustomerID, ServiceName, ServiceDate, ServiceCost, CompletionDate,  UpdateStatus, PaymentStatus, Origin, AuctionedYN) Values (@customerID, @ServiceName, @ServiceDate, @ServiceCost, @CompletionDate, @null, @null,  @FirstChanged, @n)";
