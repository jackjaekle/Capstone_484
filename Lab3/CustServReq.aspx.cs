...
namespace Lab3
{
    public partial class CustServReq : System.Web.UI.Page
    {
        ...
        protected void Submit_Click(object sender, EventArgs e)
        {
            ...
            String sqlQuery = "Update Customer Set typeOfService = @servType,  ServiceDate = @reqDate,  descriptionOfNeeds = @descNeeds, CustomerCurrentAddress = @servAdd, ServicedYN = @0 WHERE CustomerID = @custID";
