...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:DropDownList ID="ddlMoveForm" runat="server"  DataTextField="MoveFormID" AutoPostBack="true"></asp:DropDownList>
    ...
    <asp:Button ID="btnShowAll" runat="server" Text="Show all Floors" OnClick="btnShowAll_Click"/>

    <fieldset>
        <legend>
            <asp:Label ID="lblRoomInfo" runat="server" Text="Rooms Information"></asp:Label>
        </legend>
        <asp:GridView ID="grdRoomInfo" runat="server">
            <Columns>
            </Columns>
        </asp:GridView>
    </fieldset>
