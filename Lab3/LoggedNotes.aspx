<%@ Page Title="" Language="C#" MasterPageFile="~/LoggedinMaster.Master" AutoEventWireup="true" CodeFile="LoggedNotes.aspx.cs" Inherits="Lab3.LoggedNotes" %>
...
<!--Noah  George, William Kilpatrick, Henry Requeno-Villeda  2/15/2021 -->
    <div style="height: 551px; width: 1247px;">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<asp:DropDownList ID="ServiceDDL" AutoPostBack = "true" runat ="server" OnSelectedIndexChanged ="ServiceDDL_SelectedIndexChanged"></asp:DropDownList>
            <br />
