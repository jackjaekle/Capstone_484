...
<!--Noah  George, William Kilpatrick, Henry Requeno-Villeda  2/15/2021 -->
    <div style="height: 551px">
     ...
     <br />
            ...
            <asp:Button ID="AuctionPickUpForm" runat="server" Text="Edit Auction Pick Up Dates" OnClick="AuctionPickUpForm_Click" />
            

            <br />
            

            <asp:ListBox ID="InventoryInfo" runat="server" AutoPostBack ="true" Height="283px" Width="829px"></asp:ListBox><%--Creates A list box to display output--%>
            <br />
