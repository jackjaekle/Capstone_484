<%@ Page Title="" Language="C#" MasterPageFile="~/LoggedinMaster.Master" AutoEventWireup="true" CodeBehind="LogWorkFlowInfo.aspx.cs" Inherits="Lab2.LogWorkFlowInfo" %>
...
<!--Noah  George, William Kilpatrick, Henry Requeno-Villeda  2/15/2021 -->
    <div style="height: 551px">
            WorkFlow Information<br /><%--the page for people who are logged in--%>
            <br />
            <br />
            ...
            <br />
             <asp:Button
                    ID="btnLoadWorkFlowData"
                    runat="server"
                    Text="Show Workflow Information>"
                    OnClick="btnLoadWorkFlowData_Click" />
                <asp:Button ID="BtnShowAll" runat="server" Text="Show All Workflow Information >"
