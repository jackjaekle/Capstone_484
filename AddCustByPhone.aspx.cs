...
namespace Lab3
{
    public partial class AddCustByPhone : System.Web.UI.Page
    {
        ...
        protected void Submit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (duplicate == false)
                {
                    ...
                    String sqlQuery1 = "Insert into Customer (CustomerName, CustomerPhone, CustomerEmail, CustomerPhoneType, CustomerFoundUsBy, CustomerContactType, ServicedYN, CustomerCurrentAddress, descriptionOfNeeds ) Values (@CustomerName, @CustomerPhone, @CustomerEmail,  @ddl,  @CustomerHear, @ContactType, @n, @cAddress, @Needs)";
                    ...
                    sqlCommand1.Parameters.AddWithValue("ddl", DDL3.Text);

                    sqlCommand1.Parameters.AddWithValue("n", "1");
                    ...
                    String ChosenName = FirstLast;
                    //String orgAddress = HttpUtility.HtmlEncode(CustomerAddress.Text);
                    Response.Redirect("AddServiceByPhone.aspx?sendName=" + ChosenName);
