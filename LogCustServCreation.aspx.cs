...
namespace Lab3
{
    public partial class LogCustServCreation : System.Web.UI.Page
    {
        ...
        protected void Submit_Click(object sender, EventArgs e)
        {
            ...
            if (duplicate == false)
            {
                ...
                String sqlQuery6 = "Update Customer Set ServicedYN = @y, MoveCreateYN = @n WHERE CustomerID = @custID";
                ...
                sqlCommand6.Parameters.AddWithValue("n", 0);
